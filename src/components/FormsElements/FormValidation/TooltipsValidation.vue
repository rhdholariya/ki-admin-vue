...
const validateField = (field) => {
  switch (field) {
    case 'userName':
      errors.value.userName = formData.value.userName.trim()
          ? ''
          : 'Invalid User Name. Please use alphanumeric characters.'
      break
    case 'email':
    ...
    case 'password':
      errors.value.password = formData.value.password.length <= 8
          ? ''
          : 'Invalid Password. It should have a maximum of 8 characters.'
      break
    case 'address':
      errors.value.address = formData.value.address.trim()
          ? ''
          : 'Invalid Address. Please enter a valid address.'
      break
    case 'address2':
      errors.value.address2 = formData.value.address2.trim()
          ? ''
          : 'Invalid Address. Please enter a valid address.'
      break
    case 'city':
      errors.value.city = formData.value.city.trim()
          ? ''
          : 'Invalid City. Please enter a valid city name.'
      break
    case 'zipCode':
      errors.value.zipCode = /^\d{5}$/.test(formData.value.zipCode)
          ? ''
          ...
          <b-col md="6">
            <b-form-group label="User Name">
              <b-form-input
                  ...
                  :state="errors.userName ? false : (formData.userName ? true : null)"
          ...
          <b-col md="6">
            <b-form-group label="Email">
              <b-form-input
                  ...
                  :state="errors.email ? false : (formData.email ? true : null)"
          ...
          <b-col md="6">
            <b-form-group label="Password">
              <b-form-input
                  ...
                  :state="errors.password ? false : (formData.password ? true : null)"
          ...
          <b-col md="6">
            <b-form-group label="Address">
              <b-form-input
                  ...
                  :state="errors.address ? false : (formData.address ? true : null)"
          ...
          <b-col md="6">
            <b-form-group label="Address 2">
              <b-form-input
                  ...
                  :state="errors.address2 ? false : (formData.address2 ? true : null)"
          ...
          <b-col md="6">
            <b-form-group label="City">
              <b-form-input
                  ...
                  :state="errors.city ? false : (formData.city ? true : null)"
          ...
          <b-col md="6">
            <b-form-group label="Zip Code">
              <b-form-input
                  ...
                  :state="errors.zipCode ? false : (formData.zipCode ? true : null)"
