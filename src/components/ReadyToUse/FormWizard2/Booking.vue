                ...
                <b-col lg="8">
                    <div class="tab-contents-list">
                                        ...
                                        <b-card class="shadow-none">
                                            <b-card-body>
                                                ...
                                                <div class="text-center">
                                                    <img src="/images/form/19.png" alt="Location 1" style="width: 60px; height: 60px;" />
                                    ...
                                    <b-col md="6" xl="4">
                                        <b-card class="shadow-none">
                                            <b-card-body>
                                                <b-form-radio name="radio-group1" />
                                                <div class="text-center">
                                                    <img src="/images/form/20.png" alt="Location 2" style="width: 60px; height: 60px;" />
                        ...
                        <div v-if="activeTab === 'tabs-3'">
                            <b-accordion v-model="activeAccordion" class="accordion app-accordion accordion-light-primary">
