...
const financingOptions = [
    {
        value: 'marketing',
        label: 'Marketing',
        img: '/images/form/16.png',
        desc: 'Identifying a company’s target market.'
    },
    {
        value: 'finance',
        label: 'Finance',
        img: '/images/form/17.png',
        desc: 'Researching the business’s target market and customer base.'
    },
    {
        value: 'it-support',
        label: 'IT Support',
        img: '/images/form/18.png',
        desc: 'Creating digital and/or print content to generate brand.'
    }
]
                    ...
                    <div class="tab-contents-list">
                        ...
                        <div v-if="activeTab === 'tab-1'">
                            <b-form class="app-form">
                                <b-row>
                                    <b-col v-for="field in formFields" :key="field.id"
                                           :md="field.id === 'address' ? 12 : 6"
                                           :xl="['dob', 'email', 'contact'].includes(field.id) ? 4 : 6">
                                        <b-form-group :label="field.label" class="mb-3">
                                            ...
                                            <b-form-textarea v-else-if="field.type === 'textarea'" :id="field.id"
                                                             :name="field.name" :rows="field.rows"
                                                             :placeholder="field.placeholder"/>
                                            <b-form-input v-else :type="field.type" :id="field.id" :name="field.name"
                            ...
                            <b-form class="app-form">
                                ...
                                <b-accordion flush class="mt-4">
                                            ...
                                            <b-col v-for="opt in section.options" :key="opt.value" md="6" xl="4">
                                                <b-card class="shadow-none">
                                                    <b-card-body class="address-content text-center">
                                                        <b-form-radio :id="opt.value" :name="`radio-${section.title}`"
                                                                      :value="opt.value">
                                                            <template #label>
                                                                <img :src="opt.img" :alt="opt.label"
                                    ...
                                    <b-accordion-item title="Existing Balance">
                                        ...
                                        <b-form-group class="mb-3">
                                            <b-row>
                                                <b-col sm="2"><label class="col-form-label">Current Balance</label>
                                                </b-col>
                                                <b-col sm="10">
                                                    <b-input-group>
                                                        <span class="input-group-text"><PhCreditCard size="20"
                                                                                                     weight="fill"
