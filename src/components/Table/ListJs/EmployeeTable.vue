...
const employees = ref([
    ...
    {id: 3, name: 'Rose Bush', email: 'rose@gmail.com', contact: '9674903425', date: '2020-10-26', status: 'ACTIVE'},
    {id: 4, name: 'Dave Allippa', email: 'dave@gmail.com', contact: '6490537289', date: '2020-06-19', status: 'BLOCK'}
])
...
const form = ref({id: 0, name: '', email: '', contact: '', date: '', status: 'ACTIVE'})
...
const filteredEmployees = computed(() => {
    ...
    return employees.value.filter(emp =>
        ...
        emp.contact.includes(search.value) ||
        emp.date.includes(search.value) ||
        emp.status.toLowerCase().includes(search.value.toLowerCase())
    )
})
                ...
                <b-card-body class="p-2">
                    ...
                    <div class="list-pagination p-3">
                        <ul class="pagination mb-0">
                            <li class="active">
                                <RouterLink class="page" to="#" data-i="1" data-page="4">1</RouterLink>
                            </li>
                        </ul>
                    </div>
                </b-card-body>
