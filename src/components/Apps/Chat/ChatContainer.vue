    ...
    <b-card-header>
      <div class="chat-header d-flex align-items-center ms-lg-0 ms-5">
        ...
        <router-link to="/apps/profile">
          <span class="profileimg h-45 w-45 d-flex-center b-r-50 position-relative bg-secondary">
        ...
        <!-- Call Button -->
        <b-button variant="success" class="h-45 w-45 icon-btn b-r-22 me-sm-2" @click="toggleCallModal">
          <icon-phone-call size="18" />
        </b-button>

        <!-- Call Modal -->
        <b-modal v-model="callModal" centered hide-footer hide-header>
          <div class="call">
            <div class="call-div">
              ...
              <div class="call-caption text-center">
                ...
                <div class="d-flex justify-content-center">
                  <b-button variant="success" class="h-40 w-40 icon-btn b-r-50 call-btn" @click="toggleCallModal">
                    <icon-phone-call size="18" />
                  </b-button>
                  <b-button variant="danger" class="h-40 w-40 icon-btn b-r-50 ms-4 call-btn" @click="toggleCallModal">
                    <icon-phone-call size="18" />
                  </b-button>
                </div>
              </div>
        ...
        <!-- Video Button -->
        <b-button variant="primary" class="h-45 w-45 icon-btn b-r-22 me-sm-2" @click="toggleVideoModal">
          <icon-video size="18" />
        </b-button>

        <!-- Video Modal -->
        <b-modal v-model="videoModal" centered hide-footer hide-header>
          <div class="call">
            <div class="call-div pointer-events-auto">
              ...
              <div class="call-caption">
                <div class="d-flex justify-content-center align-items-center">
                  ...
                  <b-button variant="danger" class="h-45 w-45 icon-btn b-r-50 ms-4 call-btn" @click="toggleVideoModal">
                    <icon-phone-call size="18" />
                  </b-button>
                  <span class="bg-white h-35 w-35 d-flex-center b-r-50 ms-4">
        ...
        <!-- Settings Dropdown -->
        <b-dropdown class="dropdown-icon-none" toggle-class="h-45 w-45 icon-btn b-r-22 me-sm-2" variant="secondary">
          <template #button-content>
            <icon-settings size="18" />
          </template>

          <b-dropdown-item href="#">
            <icon-brand-hipchat size="18" /> <span class="f-s-13 ms-1">Chat Settings</span>
          </b-dropdown-item>
          <b-dropdown-item href="#">
            <icon-phone-call size="18" /> <span class="f-s-13 ms-1">Contact Settings</span>
          </b-dropdown-item>
          <b-dropdown-item href="#">
            <icon-settings size="18" /> <span class="f-s-13 ms-1">Settings</span>
          </b-dropdown-item>
        </b-dropdown>
      </div>
    </b-card-header>
        ...
        <div v-for="chat in chatmessages" :key="chat.id" class="position-relative">
          ...
          <template v-if="chat.position === 'left'">
            ...
            <div class="chat-box">
              ...
              <p class="text-muted">
                <icon-checks size="18" class="text-primary" /> {{ chat.time }}
              </p>
            </div>
          </template>
      ...
      <div class="chat-footer d-flex">
        ...
        <div class="app-form flex-grow-1">
          <b-input-group>
            ...
            <b-form-input type="text" class="b-r-6" placeholder="Type a message" />
            <b-button variant="primary" class="btn-sm ms-2 me-2 b-r-4">
              <icon-send size="18" /> <span>Send</span>
            </b-button>
          </b-input-group>
        </div>
        ...
        <div class="d-none d-sm-flex">
          <b-button id="mic-btn" variant="secondary" class="w-50 h-50 icon-btn ms-2">
            <icon-microphone size="18" />
          </b-button>
          <b-tooltip target="mic-btn" placement="top">Microphone</b-tooltip>

          <b-button id="camera-btn" variant="secondary" class="w-50 h-50 icon-btn ms-2">
            <icon-camera-plus size="18" />
          </b-button>
          <b-tooltip target="camera-btn" placement="top">Camera</b-tooltip>

          <b-button id="attach-btn" variant="secondary" class="w-50 h-50 icon-btn ms-2">
        ...
        <!-- Mobile Dropdown -->
        <b-dropdown class="dropdown-icon-none d-sm-none" toggle-class="d-flex-center ms-1 p-0" variant="light-primary">
          <template #button-content>
            <icon-dots-vertical size="18" />
          </template>

          <b-dropdown-item href="#">
            <icon-microphone size="18" /> <span class="f-s-13 ms-1">Microphone</span>
          </b-dropdown-item>
          <b-dropdown-item href="#">
            <icon-camera-plus size="18" /> <span class="f-s-13 ms-1">Camera</span>
          </b-dropdown-item>
          <b-dropdown-item href="#">
            <icon-paperclip size="18" /> <span class="f-s-13 ms-1">Paperclip</span>
          </b-dropdown-item>
        </b-dropdown>
      </div>
    </b-card-footer>
