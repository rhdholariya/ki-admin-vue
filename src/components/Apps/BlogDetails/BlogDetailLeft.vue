...
// Handle form
const handleChange = (field, value) => newComment.value[field] = value;
...
const handleSubmit = (e) => {
  ...
  comments.value = [{ ...newComment.value, quote, time: "Just now", tags: [] }, ...comments.value];
  newComment.value = { name: "", email: "", comment: "", quote: "", time: "" };
};

onMounted(() => initializeLightboxSources());
</script>
      ...
      <b-card-body>
        ...
        <div class="post-div mb-3">
          <b-row>
            ...
            <b-col v-for="(img, index) in ['09','05','08','04']" :key="index" cols="6" sm="3">
          ...
          <b-row>
            <b-col md="12">
              <b-form-group class="mb-3">
                <b-form-textarea rows="3" :value="newComment.comment" @input="val => handleChange('comment', val)" placeholder="Enter Your Comment" />
              </b-form-group>
            </b-col>
            <b-col md="6">
              <b-form-group class="mb-3">
                <b-form-input type="text" :value="newComment.name" @input="val => handleChange('name', val)" placeholder="Enter Your Name" />
              </b-form-group>
            </b-col>
            <b-col md="6">
              <b-form-group class="mb-3">
                <b-form-input type="email" :value="newComment.email" @input="val => handleChange('email', val)" placeholder="Enter Your Email" />
              </b-form-group>
            </b-col>
            <b-col>
              <div class="text-end">
