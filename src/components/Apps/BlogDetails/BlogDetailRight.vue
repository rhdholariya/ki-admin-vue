...
const popularPosts = ref([
  { img: "/images/blog-app/01.jpg", text: "The Art of Landscape Photography", time: "2 hours ago", bg: "primary" },
  { img: "/images/blog-app/02.jpg", text: "10 Photography Tips for Beginners", time: "1 day ago", bg: "success" },
  { img: "/images/blog-app/03.jpg", text: "Best Cameras for 2023", time: "3 days ago", bg: "info" },
]);
  ...
  <b-row>
      ...
      <b-card no-body>
        ...
        <b-card-body>
          ...
          <div class="d-flex gap-2">
            <b-button variant="primary" class="icon-btn b-r-5"><icon-brand-facebook size="18" /></b-button>
            <b-button variant="success" class="icon-btn b-r-5"><icon-brand-whatsapp size="18" /></b-button>
            <b-button variant="info" class="icon-btn b-r-5"><icon-brand-twitter size="18" /></b-button>
            <b-button variant="dark" class="icon-btn b-r-5"><icon-brand-github size="18" /></b-button>
          </div>
        </b-card-body>
      </b-card>
    </b-col>
    ...
    <b-col md="12">
      <b-card no-body>
        ...
        <b-card-body>
          <div v-for="(post, i) in popularPosts" :key="i" class="position-relative mb-3 d-flex align-items-start">
            <b-img
                :src="post.img"
                alt=""
            ...
            />
            <div class="ms-5">
              <p class="text-dark mb-0 fw-semibold small">{{ post.text }}</p>
              <div class="text-secondary text-end small">{{ post.time }}</div>
            </div>
          </div>
          <div class="mt-3">
            <router-link to="/apps/blog-page/blog" target="_blank">
              <b-button variant="primary" class="rounded w-100"><i class="ti ti-plus me-1"></i> View All</b-button>
            </router-link>
          </div>
        </b-card-body>
      </b-card>
          ...
          <b-form class="app-form" @submit="handleSubmit">
            <b-form-group class="mb-3">
              ...
              <div class="input-group">
                <b-form-input type="email" placeholder="@gmail.com" v-model="email" required />
                <b-button type="submit" variant="primary"><icon-mail-fast size="20" /></b-button>
              </div>
            </b-form-group>
            <b-form-group>
