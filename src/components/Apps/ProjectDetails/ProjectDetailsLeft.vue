        ...
        >
          ...
          <template #cell(value)="data">
            <div class="text-end">
              ...
              <div v-else-if="data.item.name === 'Assigned By'" class="avatar-group justify-content-end">
                <span
        ...
        <div class="project-team-list">
          ...
          >
            ...
            <span
              v-else
              :class="[
                'h-35 w-35 d-flex-center rounded',
                member.color
              ]"
            >
              {{ member.initial }}
...
// Import project data
import { projectDetails, teamMembers } from "@/data/app/projectapp/ProjectDetailData.js";
...
// Computed project details table data
...
// Assigned by avatars data
const assignedByAvatars = computed(() => [
  {
    name: 'Everlee Lambert',
    initial: 'A',
  ...
  },
  {
    name: '2 More',
    initial: '2+',
    colorClass: 'text-bg-secondary h-25 w-25'
  }
]);
</script>
