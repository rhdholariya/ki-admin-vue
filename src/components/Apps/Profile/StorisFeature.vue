...
// Combine all image sources (stories + posts)
          ...
          <b-card-body>
            <swiper v-bind="swiperOptions" class="story-container app-arrow">
              <swiper-slide
                  ...
                  :key="idx"
              >
                <a @click.prevent="handleImageClick(getStoryIndex(idx) + 1)" class="story">
          ...
          <b-card-body>
            <div class="photos-container">
              ...
              <div class="left-main-img img-box">
                <a href="#" @click.prevent="handleImageClick(getPostImageIndex(0) + 1)">
              ...
              <div class="sub">
                <div
                    ...
                    class="img-box"
                >
                  <a href="#" @click.prevent="handleImageClick(getPostImageIndex(idx + 1) + 1)">
            ...
            <div class="photos-container mt-3">
              ...
              >
                <a href="#" @click.prevent="handleVideoClick(video.video)">
            ...
            <ul class="app-timeline-box">
              <li v-for="(item, index) in timelineData" :key="index" class="timeline-section">
                <div class="timeline-icon">
                  <span :class="[item.iconBg, 'h-35 w-35 d-flex-center b-r-50']">{{ item.icon }}</span>
                </div>
                  ...
                  >
                    <b-row>
                      <b-col
                          ...
                          sm="4"
                      >
                        <a href="#" @click.prevent="handleImageClick(getPostImageIndex(imgIdx) + 1)">
              ...
              <b-card no-body>
                ...
                <b-card-body>
                  <div class="d-flex justify-content-between">
                    <div>
                      <h6 class="f-s-14 f-w-500">Start: <span class="text-success">{{ project.startDate }}</span></h6>
                      <h6 class="f-s-14 f-w-500">End: <span class="text-danger">{{ project.endDate }}</span></h6>
                    </div>
                    <div class="text-end">
                ...
                <b-list-group>
                  <b-list-group-item v-for="msg in profileMessages" :key="msg.id">
                    <div class="d-flex align-items-center justify-content-between position-relative">
                      <div
                          :class="['rounded-circle d-flex-center position-absolute', 'bg-' + msg.color]"
