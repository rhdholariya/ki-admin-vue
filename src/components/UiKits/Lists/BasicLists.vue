...
const linkList = [
    { id: 1, text: "The current link item", active: true, disabled: false },
    { id: 2, text: "A second link item", active: false, disabled: false },
    { id: 3, text: "A third link item", active: false, disabled: true },
    { id: 4, text: "A fourth link item", active: false, disabled: true },
    { id: 5, text: "A disabled link item", active: false, disabled: true },
];
const buttonList = [
...
const numberedList = [
    ...
    { id: 3, text: "Numbered Item 3", color: "success", count: 4 },
];
