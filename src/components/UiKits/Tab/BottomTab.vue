...
const tabs = [
  ...
  },
  {
    ...
    iconName: "PhStar",
    content: [
      `Use the <code>:target</code> pseudoclass to show tabs, and anchors with fragment identifiers to switch between them.`,
    ],
  },
];
...
{{ `<b-tabs pills card end nav-class="flex-column app-tabs-secondary">
${tabs
  .map(
    (t) => `  <b-tab>
    <template #title>
