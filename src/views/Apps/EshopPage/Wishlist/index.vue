...
const handleIconClick = (index) => {
  heartStatus.value[index] = !heartStatus.value[index];
};
              ...
              <div class="product-content-box">
                <div class="product-grid">
                  <div class="product-image">
                    <a :href="product.productLink" target="_blank" class="image">
                      <b-img class="pic-1" :src="product.image1" :alt="product.name" fluid />
                      <b-img class="images_box" :src="product.image2" :alt="product.name" fluid />
                    </a>
                  </div>
                </div>
                ...
                <div class="p-3">
                  <div class="d-flex justify-content-between align-items-center">
                    <a :href="product.productLink" class="m-0 f-s-20 f-w-500">{{ product.name }}</a>
                  ...
                  <div class="pricing-box">
                    <h6 class="mb-0">
                      {{ product.price }} <span>(<del>{{ product.originalPrice }}</del>)</span>
                ...
                >
          <IconHeartFilled v-if="heartStatus[index]" size="18" class="heart-icon text-danger-dark" />
          <IconHeart v-else size="18" class="heart-icon text-danger-dark" />
        </span>
              </div>
            </b-card-body>
          </b-card>
