                    ...
                    <b-col sm="7" cols="12">
                      <div class="ticket-create">
                        ...
                        <p class="mb-5 mt-3 text-secondary">
                          ...
                          versus what should happen. If it's a feature request, explain the desired outcome
                          and why it's needed.
                        </p>
                        <b-button variant="primary" @click="showModal = true">Create Ticket</b-button>
                      </div>
                    </b-col>
