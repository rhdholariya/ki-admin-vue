...
const updateTimer = () => {
    ...
    if (timerActive.value && distance > 0) {
                ...
                <b-row>
                    ...
                    >
                        <b-card class="mb-4 equal-card" no-body>
                            ...
                            <b-card-body :class="section.center ? 'd-flex justify-content-center' : ''">
                                ...
                                >
                                    <ul class="timer">
                                        <li class="countdown"
                                            v-for="(value, label) in { days: 'Days', hours: 'Hours', minutes: 'Min', seconds: 'Sec' }"
                                            :key="label">
                                ...
                                >
                                    <ul class="timer">
                                        <li class="countdown" v-for="(item, index) in [
                      ...
                      { key: 'seconds', bg: 'info', text: 'Seconds' },
                                            ...
                                            <span :class="`fw-medium f-s-20 bg-light-${item.bg}`">{{
                                                    timeLeft[item.key]
                                                }}</span>
