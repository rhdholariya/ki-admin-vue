<script setup>
import { ref } from 'vue';
import { BButton, BRow, BCol, BCard, BCardBody , BContainer} from 'bootstrap-vue-next';
                            ...
                            <div class="text-editor-container p-0">
                                <div class="editor-toolbar d-flex flex-wrap">
                                    ...
                                    <div class="toolbar-group">
                                        ...
                                        <b-button variant="primary" @click="editor?.chain().focus().setTextAlign('center').run()"
                                        ...
                                        <b-button variant="primary" @click="editor?.chain().focus().setTextAlign('justify').run()"
                                    ...
                                    <div class="toolbar-group">
                                        ...
                                        <b-button variant="primary" @click="editor?.chain().focus().toggleHeading({ level: 1 }).run()"
                                                  :class="{ 'is-active': editor?.isActive('heading', { level: 1 }) }" title="Heading 1">
                                            <PhTextHOne size="18" />
                                        </b-button>
                                        <b-button variant="primary" @click="editor?.chain().focus().toggleHeading({ level: 2 }).run()"
